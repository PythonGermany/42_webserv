...
requests_data = [
    ...
    },
    {
        ...
        "expected_response": 200,
        "content_file": "../isthisworking?Ihopeitis.html",
    },
    {
        "url": "/lol😀.html",
        "expected_response": 200,
    ...
    },
    {
        "url": "/index/",
        "expected_response": 200,
        "content_file": "../multiindex/multiindex.html",
    },
    {
        "url": "/kapouet/pouic/toto/pouet",
        "expected_response": 200,
        "content_file": "../pouic/toto/pouet",
    }
]
        ...
        try:
            ...
            if response.status_code == request_data["expected_response"]:
                ...
                if content_file and not os.path.isfile(content_file):
                    print(f"Expected content file for {request_data['url']} is not a file.")
                ...
                if content_file:
                    ...
                    if response_content.strip() != expected_content.strip():
                        print(f"Response content for {full_url} does not match expected content.")
                        print("##################################################################")
                ...
                print(f"Request to {full_url} succeeded with expected response {request_data['expected_response']}.")
            else:
                print(f"Request to {full_url} failed. Expected {request_data['expected_response']}, got {response.status_code}.")
                sys.exit(1)  # Exit with a non-zero status code on error
